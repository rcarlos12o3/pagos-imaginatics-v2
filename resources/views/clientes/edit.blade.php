    ...
    <form action="{{ route('clientes.update', $cliente) }}" method="POST" class="bg-white shadow-sm rounded-lg p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input type="text" name="contacto_nombre" value="{{ old('contacto_nombre', $cliente->contacto_nombre) }}"
                       placeholder="Opcional"
                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
            ...
            <div>
                ...
                <input type="text" name="contacto_cargo" value="{{ old('contacto_cargo', $cliente->contacto_cargo) }}"
                       placeholder="Opcional"
                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">
            </div>
        </div>
        ...
        <div>
            ...
            <textarea name="direccion" rows="2" placeholder="Opcional"
                      class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-sm">{{ old('direccion', $cliente->direccion) }}</textarea>
        </div>
