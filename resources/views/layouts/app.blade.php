...
<body class="bg-gray-50 antialiased" x-data="{ hovered: false, pinned: false }" x-bind:class="{ 'sidebar-pinned': pinned }">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <aside :class="(hovered || pinned) ? 'w-64' : 'w-20'"
            ...
            <div class="h-16 flex items-center justify-between px-4 border-b border-gray-200">
                ...
                <button @click="pinned = !pinned"
                        ...
                        :class="!(hovered || pinned) && 'mx-auto'">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                              :d="pinned ? 'M11 19l-7-7 7-7m8 14l-7-7 7-7' : 'M13 5l7 7-7 7M5 5l7 7-7 7'"/>
                    </svg>
                </button>
            </div>
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <a href="{{ route('comunicaciones.index') }}"
                   class="flex items-center gap-3 px-3 py-2.5 rounded-lg transition-all {{ request()->routeIs('comunicaciones.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50' }}">
                    <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span x-show="hovered || pinned"
                          ...
                          x-transition:enter-start="opacity-0"
                          x-transition:enter-end="opacity-100"
                          class="text-sm font-medium">Comunicaciones</span>
                </a>
            ...
            <div class="border-t border-gray-200 p-4">
                <div x-show="hovered || pinned" class="space-y-3">
                ...
                <div x-show="!(hovered || pinned)" class="flex justify-center">
                    <form method="POST" action="{{ route('auth.logout') }}">
                        @csrf
